...
export default function dashboard() {
  ...
  return (
    <div className="">
      ...
      <div className="bg-gray-100 w-screen-full h-screen px-40 py-8 flex flex-col gap-4">
        <div className="flex gap-12">
          <div className="w-[400px] h-[250px] bg-white rounded-lg"></div>
          <div className="flex gap-12">
            {incomeData.map((data, index) => (
              <div
                key={index}
                className="bg-white w-[350px] h-[250px] rounded-lg"
              >
        ...
        <div className="flex gap-10">
          <div className="bg-white w-[600px] h-[250px] rounded-xl">
